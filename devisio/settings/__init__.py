...
STATICFILES_DIRS = (
    path.join(PROJECT_PATH, 'devisio/static/'),
)
...
SECRET_KEY = '8)@7#qz_!8u-u-htx3ngr51ozxl&amp;6m)fik3(b5kha*i4#gq&amp;x9'
...
TEMPLATE_DIRS = (
    path.join(PROJECT_PATH, 'devisio/templates'),
)
